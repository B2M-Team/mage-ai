...
export default {
  accent: {
    ...
    blue: BLUE_DARK,
    cyan: '#65E3FF',
    cyanLight: 'rgba(101, 227, 255, 0.5)',
  ...
  background: {
    ...
    dark: GRAY,
    dashboard: SILVER,
    dashboardTransparent: 'rgba(0, 0, 0, 0.04)',
    header: SILVER,
    menu: NAVY,
    muted: SILVER,
    navigation: '#EDEDED',
    ...
    page: WHITE,
    panel: SILVER,
    panelTransparent: 'rgba(255, 255, 255, 0.85)',
    content: '#F4F4F5',
    popup: WHITE,
    codeTextarea: WHITE,
    row: LIGHT,
    ...
    success: LIME_XLIGHT,
    successLight: 'rgba(0, 168, 26, 0.12)',
    table: WHITE,
    tag: SILVER,
  },
  borders: {
  ...
  interactive: {
    activeBorder: BLACK,
    blackBackgroundTransparent: 'rgba(0, 0, 0, 0.6)',
    ...
    hoverBlackBackgroundTransparent: 'rgba(0, 0, 0, 0.06)',
